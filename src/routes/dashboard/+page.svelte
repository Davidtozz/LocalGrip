...
<Card.Root class="h-dvh rounded-none flex-grow m-0 border-0 bg-primary-foreground flex flex-col">   
    ...
    <Card.Content class="grid grid-cols-6 grid-rows-5 gap-2 h-full m-h-full overflow-auto">

      <!-- First card -->
        <div class="h-full flex flex-col p-4 col-span-3 row-span-3 bg-card rounded-md shadow">
            <div class="px-0 py-1 text-center flex flex-row justify-between items-center">
                <h1>Total Revenue</h1>
        ...
        <Card.Root class="col-span-2 row-span-2"></Card.Root>
        <Card.Root class="col-span-2 row-span-2 bg-secondary-foreground"></Card.Root>
        <Card.Root class="col-span-2 row-span-2 bg-secondary-foreground"></Card.Root>
    </Card.Content> 
</Card.Root>    