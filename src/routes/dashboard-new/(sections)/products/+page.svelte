<script lang="ts">
    ...
    function paginate(array: number[], page_size: number, page_number: number) {
    ...
    {#if emptyArray.length === 0} 
        <Card.Root class="flex flex-1 items-center justify-center h-full">
            <div class="text-center flex flex-col gap-2">
                <h2 class="text-2xl font-semibold">No menu found</h2>
                <p class="text-sm text-muted-foreground">
                    You don't have any menus. Get started by adding a new menu.
                </p>
                <Button size="lg" class="space-x-1 w-min self-center">
            ...
            <Card.Root>
                ...
                <Table.Root>
                    ...
                    <Table.Row>
                        ...
                        <Table.Cell class="md:table.-cell">25</Table.Cell>
                        <Table.Cell class="md:table.-cell">
                        2023-07-12 10:42 AM
                        </Table.Cell>
                        <Table.Cell>
                    ...
                    <Table.Row>
                        ...
                        <Table.Cell class="md:table.-cell">100</Table.Cell>
                        <Table.Cell class="md:table.-cell">
                        2023-10-18 03:21 PM
                        </Table.Cell>
                        <Table.Cell>
                    ...
                    <Table.Row>
                        ...
                        <Table.Cell class="md:table.-cell">50</Table.Cell>
                        <Table.Cell class="md:table.-cell">
                        2023-11-29 08:15 AM
                        </Table.Cell>
                        <Table.Cell>
                    ...
                    <Table.Row>
                        ...
                        <Table.Cell class="md:table.-cell  ">$2.99</Table.Cell>
                        <Table.Cell class="md:table.-cell  ">0</Table.Cell>
                        <Table.Cell class="md:table.-cell  ">
                        2023-12-25 11:59 PM
                        </Table.Cell>
                        <Table.Cell>
                    ...
                    <Table.Row>
                        ...
                        <Table.Cell class="md:table.-cell  ">75</Table.Cell>
                        <Table.Cell class="md:table.-cell  ">
                        2024-01-01 12:00 AM
                        </Table.Cell>
                        <Table.Cell>
                    ...
                    <Table.Row>
                        ...
                        <Table.Cell class="md:table.-cell  ">30</Table.Cell>
                        <Table.Cell class="md:table.-cell  ">
                        2024-02-14 02:14 PM
                        </Table.Cell>
                        <Table.Cell>
                ...
                <div class="text-xs text-muted-foreground">
                    Showing <strong>1-10</strong> of <strong>{emptyArray.length}</strong> products
                </div>
                </Card.Footer>
            </Card.Root>
            </Tabs.Content>
